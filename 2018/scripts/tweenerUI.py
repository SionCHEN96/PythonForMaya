...
def tween(percentage, obj=None, attrs=None, selection=True):
    ...
    for attr in attrs:
        ...
        lateKeyframes = [frame for frame in keyframes if frame > currentTime]

        if not previousKeyframes and not lateKeyframes:
            continue
        ...
        nextFrame = min(lateKeyframes) if lateKeyframes else None
